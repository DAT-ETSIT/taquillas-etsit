/*
    Code taken from the jQuery Mobile project docs:
        http://demos.jquerymobile.com/1.1.1/docs/_assets/css/jqm-docs.js

    This was a dependency from the original code, but it can only be fetched
    via HTTP (hence copying it here, to serve it with HTTPS).
